...
var sharga_bersih,sharga_bersih2:String;
    ...
    rp_sisa,rp_dp,rp_cashback,rp_total_bayar,s_pyment,s_pyment2,rp_total_bayarrr,rp_total_kotor_cash:String;
begin
...
//harga bersih
  ...
  rp_bersih := 'Rp'+rupiah(paramxx)+',00';

//cashback
  paramxx := AnsiReplaceStr(cakko_cashback.Caption,'.','');
  rp_cashback := 'Rp'+rupiah(paramxx)+',00';


  paramxx := AnsiReplaceStr(edt_sisabayar.Text,'.','');
  rp_total_bayarrr := 'Rp'+rupiah(paramxx)+',00';
...
//  paramxx := AnsiReplaceStr(edt_sisabayar.Text,'.','');
  ...
  rp_total_kotor_cash := 'Rp'+rupiah(paramxx)+',00';
  ...
  if (ck_dp.Checked = true) and (s_pyment='Cash') then
    ...
    begin
      ...
      SQL.Clear;
      SQL.Text:=
      'INSERT INTO tbl_transaksi(SUDAH_CREW,KODE_TRANSAKSI,NAMA_COST,JAM_INPUT,NO_HP,JUMLAH_ORANG,JENIS_PAKET,DETAIL_FREE,HARGA_PAKET,JUMLAH_SESI,'+
...
var aa,total_harganya,hasil_diamond:Real;
param:string;
...
begin
  ...
  edt_dp.Text:='0';
    ...
    lbl_sisa.Caption := 'Rp'+rupiah(param)+',00';
end;
